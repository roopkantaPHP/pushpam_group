...
<div>
  ...
  <div class="row user_border">
    <div class="pushpam_width pushpam_team_width_640 follower">
      <div class="col l3 m3 s12">  <i class="material-icons">thumb_up</i><h5 class="happyuser">4865</h5><p>Happy User</p></div>
      <div class="col l3 m3 s12">  <i class="material-icons">perm_identity</i><h5 class="happyuser">4865</h5><p>Followers</p></div>
      <div class="col l3 m3 s12">  <i class="material-icons">grade</i><h5 class="happyuser">4865</h5><p>Achievment</p></div>
