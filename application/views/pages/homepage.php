...
<body>
    ...
    <!-- <div class="user_border follower">
     <div class="row col l12 m12 ">
       ...
       <div class="col l2 m2 s12">  <i class="material-icons">thumb_up</i><h5 class="happyuser">4865</h5><p>Happy User</p></div>
       <div class="col l2 m2 s12">  <i class="material-icons">perm_identity</i><h5 class="happyuser">4865</h5><p>Followers</p></div>
       <div class="col l2 m2 s12">  <i class="material-icons">grade</i><h5 class="happyuser">4865</h5><p>Achievment</p></div>
       <div class="col l2 m2 s12">  <i class="material-icons">comment</i><h5 class="happyuser">4865</h5><p>Answered Questions </p></div>
     </div>
       <div class="col l1 m1">
     </div>
   </div>
 ...
 <div class="">
        <div class="col l12 s12 m12 center">
          ...
          </div></div><div class="para1 col l12 s12 m12" >
          <!-- </a> -->
              <!-- <h2 class="center brown-text"><i class="material-icons">flash_on</i></h2> -->
            <p class="header col l12 m12 s12 light team_font_size mobile_margin business_icon_text">
          ...
          <div class="center">
        <div class="col l12 s12 m12 row" style="margin-left :160px;"><div class="l2 m2 s2"></div>
    ...
    <div class="message">
      <div class="container contact">
        ...
        <form class="col s6 l12 m12">
          ...
          <div class="row">
            <div class="input-field col l6 s2 m6">
