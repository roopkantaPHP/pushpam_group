...
<div>
  ...
  <div class="row user_border">
    <div class="pushpam_width follower">
      <div class="col l3 m3 s3">  <i class="material-icons">thumb_up</i><h5 class="happyuser">4865</h5><p>Happy User</p></div>
      <div class="col l3 m3 s3">  <i class="material-icons">perm_identity</i><h5 class="happyuser">4865</h5><p>Followers</p></div>
      <div class="col l3 m3 s3">  <i class="material-icons">grade</i><h5 class="happyuser">4865</h5><p>Achievment</p></div>
      <div class="col l3 m3 s3">  <i class="material-icons">comment</i><h5 class="happyuser">4865</h5><p>Answered Questions </p></div>
    </div>
  </div>
  <div class="row">
    <div class="col l12 s12 m12">
