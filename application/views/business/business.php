...
<div class="container icon-block center happy_team">
    ...
    <div class="para2"><b>
      ...
      The group strives to create meaningful living spaces, improve human well-being and
      empower through power of knowledge, health, wellness and happiness.
      Pushpam Group is headed by Mrs. Veena R.S. as Chairperson and Dr N.Manjunatha Reddy as CEO.
      He has brought in 3 decades of management expertise in all fields of management to the Group.
      Very widely travelled, with exposure to more than a decade of high living in the Middle East, UK, Europe and Asia.
      Since inception, he has instilled in the Group a very strong sense of quality and values.
...
<!-- <ul style="list-style-type:disc !important"> -->
      <li>Dr Reddy wears his love for the nature on his sleeve as he guides</li>
      <li>Group on sustainable green projects for a healthy and harmonious living.</li>
      <li>This combined with his passion for perfection is helping the group in building world Class residential units.The group is a 20 year old multinational
The group of industries dealing with agricultural produce and services required in fanning. </li>
      <!-- </ul> -->
...
<div class="para2">
  <div class="row">
    ...
    <div class="col l4 m4 s4">   <img class="rig-img" src="assets/images/business/logo2.png"><p>Agriculture conducted on strictly commercial principles an organization engaged in agribusiness. </p></div>
    <div class="col l4 m4 s4">   <img class="rig-img" src="assets/images/business/logo3.png"></img><p>Agriculture conducted on strictly commercial principles an organization engaged in agribusiness. </p></div>
